...
sample_and_inirecon_2 = model.sample_and_inirecon_2(num_filters=102, B_size=32, init_weight=sample_and_inirecon_nonkey.sample.weight)
...
params_flow_forward = list(flownet_1_forward_2.parameters()) + list(flownet_2_forward_2.parameters()) + list(flownet_3_forward_2.parameters()) + list(flownet_4_forward_2.parameters()) + list(flownet_5_forward_2.parameters())
params_flow_backward = list(flownet_1_backward_2.parameters()) + list(flownet_2_backward_2.parameters()) + list(flownet_3_backward_2.parameters()) + list(flownet_4_backward_2.parameters()) + list(flownet_5_backward_2.parameters())
params_prob = list(Prob_net_2.parameters())
params_all_2 = params_flow_forward + params_flow_backward + params_prob
optimizer_all_2 = optim.Adam(params_all_2, lr=0.0001)

if flag:
    dict1 = torch.load('./check_point1/spl_optical_flow_video_step2_0.5_0.1_3.ckpt')
    ...
    flownet_1_forward_2.load_state_dict(dict1['state_dict_flownet_1_forward_1'])
    flownet_2_forward_2.load_state_dict(dict1['state_dict_flownet_2_forward_1'])
    flownet_3_forward_2.load_state_dict(dict1['state_dict_flownet_3_forward_1'])
    flownet_4_forward_2.load_state_dict(dict1['state_dict_flownet_4_forward_1'])
    flownet_5_forward_2.load_state_dict(dict1['state_dict_flownet_5_forward_1'])

    flownet_1_backward_2.load_state_dict(dict1['state_dict_flownet_1_backward_1'])
    flownet_2_backward_2.load_state_dict(dict1['state_dict_flownet_2_backward_1'])
    flownet_3_backward_2.load_state_dict(dict1['state_dict_flownet_3_backward_1'])
    flownet_4_backward_2.load_state_dict(dict1['state_dict_flownet_4_backward_1'])
    flownet_5_backward_2.load_state_dict(dict1['state_dict_flownet_5_backward_1'])

    Prob_net_2.load_state_dict(dict1['state_dict_Prob_net_1'])
...
if __name__ == '__main__':
    ...
    for epoch in range(0, 3601):
        ...
        for i, (inputs, f_index) in enumerate(train_loader):
            ...
            all_loss = recnLoss_1_forward_2 + recnLoss_1_backward_2 + recnLoss_1_3
            all_loss.backward()
            optimizer_all_2.step()

            if ((i % 100) == 0):
                print(f_index + 1)
                print(
                    " L0: %0.6f  L_i_pre: %0.6f L_i_forward: %0.6f L_i_forward_new: %0.6f L_i_backward: %0.6f L_i_backward_new: %0.6f L8: %0.6f L_fusion: %0.6f L_new: %0.6f L_new2: %0.6fIterations: %4d/%4d  " % (
                        ...
                        recnLoss_8.item(), recnLoss_1_1.item(), recnLoss_1_2.item(), recnLoss_1_3.item(), i, len(train_loader)))
                f = open('train_0.5_0.1_step3.txt', 'a')
        ...
        if ((epoch % 50) == 0 and epoch > 0):
            dict1 = {
                ...
                'state_dict_optimizer_all_2': optimizer_all_2.state_dict(),
            ...
            torch.save(dict1, './check_point1' + "/spl_optical_flow_video_step3_0.5_0.1_" + str(checkpoint_counter) + ".ckpt")
            checkpoint_counter += 1
