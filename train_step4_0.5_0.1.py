...
sample_and_inirecon_nonkey = model.sample_and_inirecon(num_filters=10, B_size=32)
...
sample_and_inirecon_2 = model.sample_and_inirecon_2(num_filters=10, B_size=32, init_weight=sample_and_inirecon_nonkey.sample.weight)
...
# residual reconstruction
sample_and_inirecon_3 = model.sample_and_inirecon_2(num_filters=10, B_size=32, init_weight=sample_and_inirecon_nonkey.sample.weight)
...
if flag:
    dict1 = torch.load('./check_point1/spl_optical_flow_video_step3_0.5_0.01_1.ckpt')
    ...
    sample_and_inirecon_3.load_state_dict(dict1['state_dict_sample_and_inirecon_2'])
    Biv_Shr1_3.load_state_dict(dict1['state_dict_Biv_Shr1_2'])
    Biv_Shr2_3.load_state_dict(dict1['state_dict_Biv_Shr2_2'])
    Biv_Shr3_3.load_state_dict(dict1['state_dict_Biv_Shr3_2'])
    wiener_net1_3.load_state_dict(dict1['state_dict_wiener_net1_2'])
    wiener_net2_3.load_state_dict(dict1['state_dict_wiener_net2_2'])
    wiener_net3_3.load_state_dict(dict1['state_dict_wiener_net3_2'])
...
train_loader = dataloder.DataLoader(trainset, batch_size=12, shuffle=True, num_workers=1, pin_memory=True)

params_ininet_3 = list(sample_and_inirecon_3.sample_transpose.parameters())
params_Biv_Shr_3 = list(Biv_Shr1_3.parameters()) + list(Biv_Shr2_3.parameters()) + list(Biv_Shr3_3.parameters())
params_wienet_3 = list(wiener_net1_3.parameters()) + list(wiener_net2_3.parameters()) + list(wiener_net3_3.parameters())
params_splnet_3 = params_ininet_3 + params_Biv_Shr_3 + params_wienet_3
optimizer_splnet_3 = optim.Adam(params_splnet_3, lr=0.0001)
...
if __name__ == '__main__':
    ...
    for epoch in range(0, 3601):
        ...
        for i, (inputs, f_index) in enumerate(train_loader):
            ...
            out_F_1_3 = prob_2[:, [0], :, :] * f1_1_pred_fw_2 + prob_2[:, [1], :, :] * f1_1_pred_bw_2 + prob_2[:, [2],
                                                                                                        :,
                                                                                                        :] * out_F_1_2
            ...
            delta_F = F_1 - out_F_1_3
            biv_1 = Biv_Shr1_2(delta_F, False)
            biv_2 = Biv_Shr2_2(delta_F, False)
            biv_3 = Biv_Shr3_2(delta_F, False)

            constrant_loss1 = torch.mean(
                torch.norm((delta_F - biv_1), p=2, dim=(2, 3)) * torch.norm((delta_F - biv_1), p=2, dim=(2, 3)))
            constrant_loss2 = torch.mean(
                torch.norm((delta_F - biv_2), p=2, dim=(2, 3)) * torch.norm((delta_F - biv_2), p=2, dim=(2, 3)))
            constrant_loss3 = torch.mean(
                torch.norm((delta_F - biv_3), p=2, dim=(2, 3)) * torch.norm((delta_F - biv_3), p=2, dim=(2, 3)))

            recnLoss_1_3 = torch.mean(
                torch.norm((F_1 - out_F_1_3), p=2, dim=(2, 3)) * torch.norm((F_1 - out_F_1_3), p=2, dim=(2, 3)))
            recnLoss_1_4 = torch.mean(
                torch.norm((F_1 - out_F_1_4), p=2, dim=(2, 3)) * torch.norm((F_1 - out_F_1_4), p=2, dim=(2, 3)))

            recnLoss_1_2 = torch.mean(
                torch.norm((F_1 - out_F_1_2), p=2, dim=(2, 3)) * torch.norm((F_1 - out_F_1_2), p=2, dim=(2, 3)))
            ...
            recnLoss_1_forward_2 = torch.mean(
                torch.norm((F_1 - f1_1_pred_fw_2), p=2, dim=(2, 3)) * torch.norm((F_1 - f1_1_pred_fw_2), p=2,
                                                                                 dim=(2, 3)))
            recnLoss_1_backward_2 = torch.mean(
                torch.norm((F_1 - f1_1_pred_bw_2), p=2, dim=(2, 3)) * torch.norm((F_1 - f1_1_pred_bw_2), p=2,
                                                                                 dim=(2, 3)))

            all_loss = recnLoss_1_4 + 0.01 * (constrant_loss1 + constrant_loss2 + constrant_loss3)
            all_loss.backward()
            optimizer_splnet_3.step()

            if ((i % 100) == 0):
                print(f_index + 1)
                print(
                    " L0: %0.6f  L_i_pre: %0.6f L_i_forward: %0.6f L_i_forward_new: %0.6f L_i_backward: %0.6f L_i_backward_new: %0.6f L8: %0.6f L_fusion: %0.6f L_new: %0.6f L_new2: %0.6f L_new3: %0.6f Iterations: %4d/%4d  " % (
                        recnLoss_0.item(), recnLoss_1_pre.item(), recnLoss_1_forward_1.item(), recnLoss_1_forward_2.item(),
                        recnLoss_1_backward_1.item(), recnLoss_1_backward_2.item(),
                        recnLoss_8.item(), recnLoss_1_1.item(), recnLoss_1_2.item(), recnLoss_1_3.item(), recnLoss_1_4.item(), i, len(train_loader)))
                f = open('train_0.5_0.1_step4.txt', 'a')
                f.write(" %0.6f %d " % (recnLoss_1_2.item(), epoch))
                f.write('\n')
                f.close()
        ...
        if ((epoch % 10) == 0 and epoch > 0):
            dict1 = {
                ...
                'state_dict_optimizer_splnet_3': optimizer_splnet_3.state_dict(),
                ...
                'state_dict_sample_and_inirecon_2': sample_and_inirecon_2.state_dict(),
                'state_dict_Biv_Shr1_2': Biv_Shr1_2.state_dict(),
                'state_dict_Biv_Shr2_2': Biv_Shr2_2.state_dict(),
                'state_dict_Biv_Shr3_2': Biv_Shr3_2.state_dict(),
                'state_dict_wiener_net1_2': wiener_net1_2.state_dict(),
                'state_dict_wiener_net2_2': wiener_net2_2.state_dict(),
                'state_dict_wiener_net3_2': wiener_net3_2.state_dict(),

                'state_dict_flownet_1_forward_2': flownet_1_forward_2.state_dict(),
                'state_dict_flownet_2_forward_2': flownet_2_forward_2.state_dict(),
                'state_dict_flownet_3_forward_2': flownet_3_forward_2.state_dict(),
                'state_dict_flownet_4_forward_2': flownet_4_forward_2.state_dict(),
                'state_dict_flownet_5_forward_2': flownet_5_forward_2.state_dict(),
                'state_dict_flownet_1_backward_2': flownet_1_backward_2.state_dict(),
                'state_dict_flownet_2_backward_2': flownet_2_backward_2.state_dict(),
                'state_dict_flownet_3_backward_2': flownet_3_backward_2.state_dict(),
                'state_dict_flownet_4_backward_2': flownet_4_backward_2.state_dict(),
                'state_dict_flownet_5_backward_2': flownet_5_backward_2.state_dict(),
                'state_dict_Prob_net_2': Prob_net_2.state_dict(),
                'state_dict_sample_and_inirecon_3': sample_and_inirecon_3.state_dict(),
                'state_dict_Biv_Shr1_3': Biv_Shr1_3.state_dict(),
                'state_dict_Biv_Shr2_3': Biv_Shr2_3.state_dict(),
                'state_dict_Biv_Shr3_3': Biv_Shr3_3.state_dict(),
                'state_dict_wiener_net1_3': wiener_net1_3.state_dict(),
                'state_dict_wiener_net2_3': wiener_net2_3.state_dict(),
                'state_dict_wiener_net3_3': wiener_net3_3.state_dict()

            }
            torch.save(dict1, './check_point1' + "/spl_optical_flow_video_step4_0.5_0.1.ckpt")
            checkpoint_counter += 1
